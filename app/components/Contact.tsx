      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="glass-card p-8 text-center group">
            ...
            <div className="text-[#64748b] text-xs uppercase tracking-wider mb-2">Call Us</div>
            <a
              href="tel:+19785947277"
              className="text-white font-semibold text-lg hover:text-[#c9a84c] transition-colors"
            >
              +1 (978) 594-7277
            </a>
            <div className="text-[#64748b] text-xs mt-2">Available 24/7</div>
          </div>
